...
public class PartsModel 
{
	...
	public String refreshPartList(int n)
	{
		...
		{
			text = (partArray[n][0] + ", " + partArray[n][1] + ", " + partArray[n][2] + ", " + partArray[n][3]);
			return this.text;
		}
		if(partArray[n][4] == null)
		{
			text = (partArray[n][0] + ", " + partArray[n][1] + ", " + partArray[n][2] + ", " + partArray[n][3] + ", " + partArray[n][5]);
			return this.text;
		}
		if(partArray[n][5] == null)
		{
			text = (partArray[n][0] + ", " + partArray[n][1] + ", " + partArray[n][2] + ", " + partArray[n][3] + ", " + partArray[n][4]);
			return this.text;
		}
		else
		{
			text = (partArray[n][0] + ", " + partArray[n][1] + ", " + partArray[n][2] + ", " + partArray[n][3] + ", " + partArray[n][4] + ", " + partArray[n][5]);
			return this.text;
		}
	}
	
	public void addPart(String name, String number, String vendor, String external)
	{
		for(int a = 0; a < partArray.length; a++)
		{
			if(partArray[a][1] == null)
			{
				...
				pdg.addPartRow(partArray[a][1],partArray[a][2],partArray[a][3],partArray[a][4],partArray[a][5]);
				a = partArray.length;
				continue;
			}
	...
	public String getPart(int index)
	{
		for(int g = 0; g < partArray.length; g++)
		{
			if(g == index)
			{
				text = (partArray[g][0] + " " + partArray[g][1] + " " + partArray[g][2] + " " + partArray[g][3] + " " + partArray[g][4] + " " + partArray[g][5]);
				return text;
			}
		}
		return "N/A";
	...
	public int editPart(String id, String name, String number, String vendor, String external, String copyid, String copyname, String copynumber, String copyvendor, String copyexternal)
	{
		for(int e = 0; e < partArray.length; e++)
		{
			if(partArray[e][1].equalsIgnoreCase(name) && !name.equalsIgnoreCase(copyname))
			{
				System.out.println("Similar part name found, edit failed.");
				return 1;
			}
			if(partArray[e][2].equalsIgnoreCase(number) && !number.equalsIgnoreCase(copynumber))
			{
				System.out.println("Similar part number found, edit failed.");
				return 1;
			}
			if(partArray[e][0].equalsIgnoreCase(copyid) && partArray[e][1].equalsIgnoreCase(copyname) && partArray[e][2].equalsIgnoreCase(copynumber))
			{
				partArray[e][0] = id;
				partArray[e][1] = name;
				...
				pdg.updatePartRow(partid,partArray[e][1],partArray[e][2],partArray[e][3],partArray[e][4],partArray[e][5]);
				return 1;
			}
		}
		return 0;
	...
	public String refreshItemList(int n)
	{
		...
		{
			text = (itemArray[n][0] + ", " + itemArray[n][1] + ", " + itemArray[n][2] + ", " + itemArray[n][3]);
			return this.text;
		}
	}
	...
	public void addItem(String partname, String amount)
	{
		for(int a = 0; a < itemArray.length; a++)
		{
			if(itemArray[a][1] == null)
			{
				...
				pdg.addItemRow(itemArray[a][1],itemArray[a][2],itemArray[a][3]);
				a = itemArray.length;
				continue;
			}
			if(itemArray[a][1].equalsIgnoreCase(partname) && itemArray[a][2].equalsIgnoreCase(this.getLocation()))
			{
				a = itemArray.length;
				System.out.println("Similar part name/location found, add failed.");
			}
		}
	}
	...
	public String getItem(int index)
	{
		for(int g = 0; g < itemArray.length; g++)
		{
			if(g == index)
			{
				text = (itemArray[g][0] + " " + itemArray[g][1] + " " + itemArray[g][2] + " " + itemArray[g][3]);
				return text;
			}
		}
		return "N/A";
	...
	public int editItem(String id, String partname, String amount, String copyid, String copypartname, String copyamount) //String locationName, String copyamount)
	{
		for(int e = 0; e < itemArray.length; e++)
		{
			if(itemArray[e][1].equalsIgnoreCase(partname) && !partname.equalsIgnoreCase(copypartname))
			{
				if(itemArray[e][2].equalsIgnoreCase(this.getLocation()))
				{
					System.out.println("Similar part name/location found, edit failed.");
					return 1;
				}
			}
			if(itemArray[e][0].equalsIgnoreCase(copyid) && itemArray[e][1].equalsIgnoreCase(copypartname) && itemArray[e][3].equalsIgnoreCase(copyamount))
			{
				itemArray[e][0] = id;
				...
				Integer partid = Integer.parseInt(id);
				pdg.updateItemRow(partid,itemArray[e][1],itemArray[e][2],itemArray[e][3]);
				return 1;
			}
		}
		return 0;
	...
	public int checkItem(String partname, String amount, int mode)
	{
		...
		if(found == 0)
		{
			System.out.println("Part name not found, create part name if it does not exist first.");
			return 1;
		}
